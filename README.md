...
## :brain: Sobre o aplicativo

O Mordidinha é inspirado na metodologia **Food Chaining**, criada pela fonoaudióloga Cheri Fraker, que propõe a expansão gradual do repertório alimentar infantil através de "pontes" entre alimentos já aceitos e alimentos novos com características sensoriais semelhantes (textura, cor, sabor, grupo alimentar).

O app é uma ferramenta de apoio educacional e organizacional, voltada principalmente para famílias de crianças seletivas — incluindo crianças neurodivergentes (TEA, TDAH, TPS).

> :warning: **O Mordidinha não é um dispositivo médico.** Não realiza diagnósticos, não oferece tratamentos e não substitui acompanhamento profissional (médico, nutricionista, fonoaudiólogo ou terapeuta ocupacional).
...
Ideias e melhorias são sempre bem-vindas! Envie por email.

---

## :lock: Privacidade

A política de privacidade completa do Mordidinha está disponível em:

**[:page_facing_up: Política de Privacidade](./PRIVACY_POLICY.md)**
...
## :wastebasket: Como apagar seus dados
