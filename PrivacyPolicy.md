...
**Equipe Mordidinha**
Email de contato: **[suporte.parachoques@gmail.com](mailto:suporte.parachoques@gmail.com)**

---

## 3. Resumo (TL;DR)

* ✅ **Seus dados ficam no seu dispositivo.** Não temos servidores próprios, não temos banco de dados, não armazenamos nada sobre você ou seu filho.
* ✅ Quando você solicita uma análise, os dados necessários são enviados temporariamente ao Google Cloud (Vertex AI) para processamento. Após a resposta, esses dados não são retidos em nossa infraestrutura.
* ✅ Não há cadastro nem login. O aplicativo oferece planos de assinatura opcionais.
* ✅ Para excluir tudo, basta desinstalar o app.
* ❌ Não compartilhamos nada com anunciantes, não vendemos dados e não rastreamos você.
...
| Google Cloud Vertex AI (Gemini)              | Geração da análise de IA                                 | https://cloud.google.com/terms/cloud-privacy-notice                                                                    |
| Google Cloud Vertex AI – Zero Data Retention | Política de retenção de dados                            | https://docs.cloud.google.com/vertex-ai/generative-ai/docs/vertex-ai-zero-data-retention?hl=pt-br#training-restriction |
...
* Dados financeiros ou de pagamento (os pagamentos das assinaturas são processados exclusivamente pela Apple, e não temos acesso aos dados do seu cartão ou demais informações de pagamento)
...
O Mordidinha oferece funcionalidades opcionais por meio de assinaturas renováveis automaticamente, processadas pela Apple por meio da App Store.
...
As assinaturas são gerenciadas exclusivamente pela Apple. Não temos acesso aos seus dados de pagamento, cartão de crédito ou informações financeiras.

O gerenciamento, renovação ou cancelamento da assinatura pode ser realizado a qualquer momento nas configurações da sua conta da App Store.
...
* **Dúvidas ou questões adicionais:** entre em contato por **[suporte.parachoques@gmail.com](mailto:suporte.parachoques@gmail.com)**
...
**Email:** [suporte.parachoques@gmail.com](mailto:suporte.parachoques@gmail.com)
